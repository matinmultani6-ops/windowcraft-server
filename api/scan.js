...
Analyze this image which contains handwritten or printed window drawings, sketches, diary notes, or measurement lists.

TASK:
Extract EVERY single window measurement from the image without skipping any.

RULES FOR DRAWINGS / SKETCHES:
1. Each rectangle/box represents a window.
2. Number inside circle (e.g. ①, ②, 1, 2) is the window number/ID.
3. Number at the top or bottom edge of the box is the WIDTH (W).
4. Number at the left or right edge of the box is the HEIGHT (H).
...
6. If a fraction like '1/2' or '½' is present after a number (e.g. '69.7 ½'), represent half-sut as '.5'. For example:
   ...
   - '81' -> '81'
   - '46.3' -> '46.3'
7. If quantity is specified like '(4)' or '4 piece' or '4 nos', include '(4)'. If no quantity is mentioned, default to 1 piece (no brackets needed).
...
Do NOT write any explanation, intro, markdown backticks, or other text. Output ONLY the lines of measurements.
`;
